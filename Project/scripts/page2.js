window.addEventListener("load",function(){
    ...
    let WorL = this.document.getElementsByClassName("newdiv")[0];
    ...
    function updateTimer(){
        ...
        if (timer_sec == -1){
            clearInterval(start);
            WorL.classList.remove('hidden');
            WorL.style.fontSize = "x-large";
            ...
            goback.innerText = "Start Over";
            goback.classList.add("main");
            goback.classList.add("gobttn");
            goback.onclick=function(){location.href='../Page2.html';}
            div_container.appendChild(goback);

            let BACK = document.createElement("button");
            BACK.innerText = "Main page";
            BACK.classList.add("main");
            BACK.classList.add("gobttn");
            BACK.onclick=function(){location.href='../Page1.html';}
            div_container.appendChild(BACK);
        }
    ...
    function generateBomb(){
        ...
        Bomb.onclick = function(){                                                                          
                    ...
                    let rightCo = leftCo + Bomb.width + 500;                                                                 //BotCo
